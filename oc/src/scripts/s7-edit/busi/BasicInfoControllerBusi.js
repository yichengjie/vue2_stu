...
/*清空第三个服务选择框中的类容*/
export function clearChoose3Info({FormData,initServiceType}){
         ...
         render: {
        	 item: function(item, escape) {
                 ...
                 return '<div>' +
                         ...
                         (caption ? '<span class="marginL5 serviceTypeSpan">' + escape(caption) + '</span>' : '') +
                         '</div>';
             },
             option: function(item, escape) {
                 ...
                 return '<div>' +
                         ...
                         '<span class="marginL5 serviceTypeSpan">' + escape(caption) + '</span>'+
                         '</div>';
             }
         }
     });
